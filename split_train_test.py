...
def main():
    ...
    dataset_train = Dataset.create(dataset_name='TrainData', dataset_project='ForeSightNEXT/BaltBest/resampled', dataset_version="0.0.1")
    ...
    dataset_test = Dataset.create(dataset_name='TestData', dataset_project='ForeSightNEXT/BaltBest/resampled', dataset_version="0.0.1")
